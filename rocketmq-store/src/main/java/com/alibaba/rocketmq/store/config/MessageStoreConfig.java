...
public class MessageStoreConfig {
    ...
    public int getMaxMsgNumBatch() {
        return maxMsgNumBatch;
    }


    public void setMaxMsgNumBatch(int maxMsgNumBatch) {
        this.maxMsgNumBatch = maxMsgNumBatch;
    }
