...
public class RebalancePushAppImpl extends RebalanceImpl {
    ...
    public void dispatchPullRequest(List<PullRequest> pullRequestList) {
        ...
        for (PullRequest pullRequest : pullRequestList) {
            ...
            log.info("rebalance, {}, add a new pull request {}", consumerGroup, pullRequest);
        }
    }
        ...
        case CONSUME_FROM_TIMESTAMP: {
            ...
            // 第一次启动，没有记录消费为点
                ...
                // 正常队列则从指定时间点开始
                    ...
                    try {
                        // 时间点需要参数配置
                        String consumeTimeStamp = this.defaultMQPushConsumerImpl.getDefaultMQPushConsumer()
                                .getConsumeTimestamp();
                        long timestamp = UtilAll.parseDate(consumeTimeStamp, UtilAll.yyyyMMddHHmmss).getTime();
